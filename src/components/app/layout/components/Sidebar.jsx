              ...
              <section className="flex items-center justify-center">
                {currentUser ? (
                  ...
                  <button
                    ...
                    className="hover:bg-green-200  hover:text-white transition-all font-bold p-2 text-sm rounded-md"
                  >
                    Iniciar sesión
                    <UilSignin className="text--400 hover:cursor-pointer inline-block ml-2" />
                  </button>
                )}
              </section>
            </div>
