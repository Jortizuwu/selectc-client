...
export const Modal = ({ children }) => {
  ...
  return (
    <div className='bg-slate-400 border border-spacing-44 border-cyan-300 bg-opacity-50 flex items-center justify-center absolute w-screen h-screen z-50'>
      <div className='bg-white shadow-lg w-full p-4 rounded-xl md:w-1/2 lg:w-1/3'>
